...
product=export_service_dev_html
web_path=/tmp/$product
node_modules_path="${web_path}/node_modules"
target_path="${web_path}/dist"
target_path_file="${target_path}/*"
git_path=ssh://git@47.107.176.36:8222/third_party/comprehensive-service-platform.git
project_path=/data/www/export-com-service/html
branch=master
...
echo "======================================"
echo "开始复制文件到部署服务器"
sudo cp -rfp $target_path_file /data/www/kk-export-com-service/html
display
exit 0